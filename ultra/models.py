...
class Ultra(nn.Module):
    ...
    def __init__(self, rel_model_cfg, entity_model_cfg, lm_vectors=None):
        # kept that because super Ultra sounds cool
        super(Ultra, self).__init__()

        self.relation_model = RelNBFNet(**rel_model_cfg)
        self.entity_model = EntityNBFNet(**entity_model_cfg, lm_vectors=lm_vectors)
...
class EntityNBFNet(BaseNBFNet):
    ...
    def __init__(self, input_dim, hidden_dims, num_relation=1, lm_vectors=None, **kwargs):
    ...
    def bellmanford(self, data, h_index, r_index, separate_grad=False):
        ...
        if self.lm_vectors is not None:
            ...
            # concat language model vectors to the feature
